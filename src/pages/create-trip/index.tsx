              ...
              <div className="px-4 h-16 bg-zinc-900 rounded-xl flex items-center shadow-shape">
                ...
                >
                  ...
                  {emailsToInvite.length > 0 ? (
                    <span className="text-zinc-100s text-lg flex-1">{emailsToInvite.length} pessoa(s) convidada(s)</span>
                  ) : (
                ...
                <button onClick={openConfirmTipModal} className="bg-lime-300 text-lime-950 hover:bg-lime-400 px-5 py-2 gap-2 rounded-lg font-medium flex items-center">
